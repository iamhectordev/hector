...
type Config struct {
	AppToken secrets.Secret `yaml:"app_token" env:"SLACK_APP_TOKEN" secret:"slack_app_token"`
	BotToken secrets.Secret `yaml:"bot_token" env:"SLACK_BOT_TOKEN" secret:"slack_bot_token"`
