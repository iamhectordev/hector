...
1. **Read context**
   Read `docs/golden-paths.md`, `docs/architecture.md`, and the feature node via `./flow feature <slug>`.
...
5. **Create the slice file** once the user confirms.
   Write to `slices/<feature-slug>.md`.
   Run `./flow status <feature-slug> designing`.
